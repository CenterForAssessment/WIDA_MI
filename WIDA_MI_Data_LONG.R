...
WIDA_MI_Data_LONG[YEAR=="2008-2009",YEAR:="2008_2009"]
WIDA_MI_Data_LONG[YEAR=="2009-2010",YEAR:="2009_2010"]
WIDA_MI_Data_LONG[YEAR=="2010-2011",YEAR:="2010_2011"]
...
WIDA_MI_Data_LONG_2013_2014 <- subset(WIDA_MI_Data_LONG, YEAR=="2013_2014")
WIDA_MI_Data_LONG <- subset(WIDA_MI_Data_LONG, YEAR!="2013_2014")

### Set key

setkey(WIDA_MI_Data_LONG, VALID_CASE, CONTENT_AREA, YEAR, ID)
setkey(WIDA_MI_Data_LONG_2013_2014, VALID_CASE, CONTENT_AREA, YEAR, ID)


### Save results

save(WIDA_MI_Data_LONG, file="Data/WIDA_MI_Data_LONG.Rdata")
save(WIDA_MI_Data_LONG_2013_2014, file="Data/WIDA_MI_Data_LONG_2013_2014.Rdata")
