########################################################################################
###                                                                                  ###
###                WIDA_MI COVID Skip-2-year & Consecutive-year                      ###
...
load("Data/WIDA_MI_Data_LONG_2022.Rdata")
...
WIDA_MI_2022_Consecutive_Year_Config <- READING.2022.config
WIDA_MI_2022_SKIP_2_YEAR_Config <- READING.2022_SKIP_2_YEAR.config
...
WIDA_MI_SGP <- updateSGP(
        ...
        with_sgp_data_LONG = WIDA_MI_Data_LONG_2022,
        steps = c("prepareSGP", "analyzeSGP", "combineSGP"),
        sgp.config = WIDA_MI_2022_SKIP_2_YEAR_Config,
...
WIDA_MI_SGP@Data[YEAR=="2022", (to.variable.names.sgp):=.SD, .SDcols=from.variable.names.sgp]
WIDA_MI_SGP@Data[YEAR=="2022", (to.variable.names.sgp.baseline):=.SD, .SDcols=from.variable.names.sgp.baseline]

sgps.2022.baseline <- grep(".2022.BASELINE", names(WIDA_MI_SGP@SGP[["SGPercentiles"]]))
sgps.2022 <- setdiff(grep(".2022", names(WIDA_MI_SGP@SGP[["SGPercentiles"]])), sgps.2022.baseline) 
names(WIDA_MI_SGP@SGP[["SGPercentiles"]])[sgps.2022.baseline] <- gsub(".2022.BASELINE", ".2022.BASELINE.SKIP_2_YEAR", names(WIDA_MI_SGP@SGP[["SGPercentiles"]])[sgps.2022.baseline])
names(WIDA_MI_SGP@SGP[["SGPercentiles"]])[sgps.2022] <- gsub(".2022", ".2022.SKIP_2_YEAR", names(WIDA_MI_SGP@SGP[["SGPercentiles"]])[sgps.2022])
...
WIDA_MI_SGP <- abcSGP(
        ...
        sgp.config = WIDA_MI_2022_Consecutive_Year_Config,
        sgp.percentiles = TRUE,
        sgp.projections = FALSE,
        sgp.projections.lagged = FALSE,
